...
class ExchangeServiceAPI:
    ...
    API_URL = "https://ed-dev-apim-core-xangai-esi.azure-api.net/api/bapi/cambio/v1/cotacao/{currency}/{date}"

    def get_quote(self, currency: str, date: str, bulletin_type: str) -> List[Dict]:
        try:
